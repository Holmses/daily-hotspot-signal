...
像“高考前千万不要吃榴莲”这类题材，核心不是大事件，而是“时间节点 + 明确人群 + 反常识提醒 + 可操作解释”。默认策略会额外识别：

- 标题钩子：`千万不要`、`别再`、`提醒`、`避坑`、`很多人不知道`
- 人群节点：`高考`、`中考`、`考生`、`家长`、`老人`、`儿童`
- 季节场景：`高温`、`暴雨`、`台风`、`暑假`、`开学`
- 生活建议：`吃`、`睡`、`过敏`、`犯困`、`血糖`、`肠胃`、`榴莲`

日报会给这类热点加权，并在每个候选详情里输出二创标题模板。涉及饮食、健康、安全的选题，报告会提示补营养师、医生、官方科普或原采访来源，避免把热搜提醒做成未经核验的结论。
